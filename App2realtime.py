...
df=yf.download('AAPL', start='2001-01-01', end='2024-10-18')
...
model.fit(x_train, y_train, batch_size=62, epochs=5)
...
start=df.index[-1] 
apple_quote2=yf.download('AAPL',start,period='1mo',interval='1d')
